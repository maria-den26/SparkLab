...
| Операция | ORC (мс) | Parquet (мс) | ORC Размер (MB) | Parquet Размер (MB) |
|----------|----------|--------------|-----------------|---------------------|
| **Запись БЕЗ сортировки** | 188 | 219 | 0.06 | 0.07 |
| **Запись С сортировкой** | 174 | 220 | 0.05 | 0.07 |
...
3. **Размер файлов**: ORC создает чуть более компактные файлы:
   - Без сортировки: **ORC меньше на 14%** (0.06 MB vs 0.07 MB)
   - С сортировкой: **ORC меньше на 29%** (0.05 MB vs 0.07 MB)

### Общий вывод:

- ✅ **Чтение данных**: ORC быстрее на 47-60% во всех операциях
- ✅ **Запись данных**: ORC быстрее на 14-21%
- ✅ **Размер файлов**: ORC создает файлы на 14-29% меньше